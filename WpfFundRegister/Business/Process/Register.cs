...
namespace WpfFundRegister.Business.Process
{
    internal class Register
    {
        ...
        {
            return RegisttedData.Select((onerecord,index) => new MoneyUsedData {ID=index,Date=onerecord.PaidDate,Price=onerecord.Price ?? 0,Classification=onerecord.Classification});
        }
