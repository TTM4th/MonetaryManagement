...
namespace WpfFundRegister.Controller
{
    class ActionLogics
    {
        ...
        internal ActionLogics(MainWindow parntFormObj,bool iswholeEditMode)
        {
        ...
        {
            ParentForm.KubunListBox.ItemsSource=DataController.Classifications.Select(item => item.FormItem).ToArray();
